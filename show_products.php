    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>產品報備表---<?php echo $data['proj_name'];?></h1>
        </section>
        ...
        <section class="content">					    	
			    	...
			    	<form id="myform" enctype="multipart/form-data" >
							...
							<div class="form-group">
								報備產品：<?php echo  $data['product_text'];?>
								<br>
							</div>
							<div class="form-group">
								整案預估金額：<?php echo $data['proj_cash'];?>
								<br>
							</div>
							<div class="form-group">
								相關產品金額：<?php echo $data['product_cash'];?>
								<br>
							</div>
							<div class="form-group">
								目前案件狀態：<?php echo $data['proj_status'];?>
								<br>
							</div>

							<div class="form-group">
								專案支援理由：<?php echo $data['proj_support'];?>
								<br>
							</div>
							<div class="form-group">
								此案銷售類型：<?php echo $str2;?>
							</div>
							<div class="form-group">
								預計下單日：<?php echo $data['single_date'];?>
								<br>
							</div>
							<div class="form-group">
								盟立業務人員：<?php echo $data['bus_name'];?>
								<br>
							</div>
							<div class="form-group">
								盟立業務電子郵件：<?php echo $data['mail'];?>
								<br>
							...
							<div class="form-group">
								使用單位(公司名稱)：<?php echo $data['com_name'];?>
								<br>
					
							</div>

							<div class="form-group">
								承辦人姓名：<?php echo $data['person_name'];?>
								<br>
					
							</div>

							<div class="form-group">
								承辦人部門單位：<?php echo $data['person_branch'];?>
								<br>
								
							</div>

							<div class="form-group">
								承辦人部門職稱：<?php echo $data['person_title'];?>
								<br>
			
							</div>

							<div class="form-group">
								承辦人電子郵件：<?php echo $data['person_mail'];?>
								<br>
						
							</div>

							<div class="form-group">
								承辦人聯絡電話：<?php echo $data['person_phone'];?>
								<br>
					
							</div>

							<div class="form-group">
								承辦人單位地址：<?php echo $data['person_address'];?>
								<br>
							</div>
              <a href="products.php" class="btn btn-primary btn-xs">上一頁</a>
						</form>	    
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
