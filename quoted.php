      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <div class = "pull-right">
		    <ul class="nav nav-pills">
			  <a href="new_quoted.php" class="btn btn-primary btn-xs">新增<span class="glyphicon glyphicon-plus"></span></a> 
		    </ul>
		  </div>
        </section>
					   ...
					   <table class="table table-bordered table-hover dataTable" style="width:80%;background-color: #ffffff">
                            ...
                            <?php foreach($data as $row):?>                            	
		   	            	    <tr>
                               	    ...
                               	    <td>
                               		    <a href="show_quoted.php?id=<?php echo $row['id']?>">編輯</a>
                               		    <a href="php/del_quoted.php?id=<?php echo $row['id']?>">刪除</a>          
                               	    </td>
                               </tr>
                           <?php endforeach;?>
                        </table>
