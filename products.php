        ...
        <section class="content-header">
          <h1>產品報備表</h1>
					<div class = "pull-right">
						<ul class="nav nav-pills">
					        <a href="productsadd.php" class="btn btn-primary btn-xs">新增產品報備表<span class="glyphicon glyphicon-plus"></span></a> 
					    </ul>
					</div>
        </section>
					    ...
					    <table class="table table-bordered table-hover dataTable" style="width:80%;background-color: #ffffff">
					    	...
					    	?>
		   	            	    <tr>
                                   	...
                                   	<td><?php echo $row['bus_phone']?></td>
                                   	<td><?php echo $row['person_name']?></td>
                                   	<td><?php echo $row['product_text']?></td>
                               	    <td>
                               		    <a href="show_products.php?id=<?php echo $row['id']?>">開啟</a>          
                               	    </td>
                               </tr>
                           <?php endforeach;?>
                        </table>
